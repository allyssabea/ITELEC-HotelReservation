	...
	<header class="navbar navbar-inverse navbar-fixed-top bs-docs-nav" role="banner"">
	  ...
	  <div class="container my-container">
		...
		<div class="row my-rows">
		  ...
		  <h5 style="font-family: freeS; color: rgb(255, 251, 251); font-size: 20px; text-align: center; opacity: 100%;
                      text-shadow: 3px 2px 2px #3d3933d5;;">Welcome, admin <?php echo $_SESSION["nm"];?>.</h5>
                  <br>
                  <br>
                  <br>
	  </div>
